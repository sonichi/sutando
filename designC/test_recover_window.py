...
spec = importlib.util.spec_from_file_location("designB", real_os.path.join(_HERE, "designC.py"))
...
C.init(root)   # constructor-time activation: dirs + striping, before any lock
