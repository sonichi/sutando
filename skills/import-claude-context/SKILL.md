...
Tests: `tests/import-claude-context-{index,extract,progress,finalize,stage}.test.py`. Parsing lives in `skills/session-recap/scripts/extract.py` (`--root`) and `src/context_resume.py`; this skill adds none of its own.
