...
```bash
python3 ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/macos-tools/scripts/contacts.py search "Bob"   # find by name
```
...
```bash
python3 ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/macos-tools/scripts/reminders.py list             # incomplete reminders
python3 ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/macos-tools/scripts/reminders.py add "Call Bob"    # add reminder
python3 ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/macos-tools/scripts/reminders.py add "Fix bug" "2026-03-17"  # with due date
python3 ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/macos-tools/scripts/reminders.py complete "Call Bob"  # mark done
```
