...
- [Worker pool design (v1)](worker-pool-design.md) — core / worker / pin table / pool vocabulary and the v1 routing policy; supersedes Decisions 2–5 of the record above.
