...
// resolveWorkspace() captures it at module-load time. Use dynamic import
// so the env assignment runs before module evaluation (static imports are
// hoisted and evaluated before the module body; dynamic imports are not).
...
const { _isVoiceTask } = await import('../src/task-bridge.js') as any;
