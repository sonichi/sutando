...
Run: python3 tests/room-doc-replace-offsets.test.py  (exit 0 pass / 1 fail)
"""
import asyncio
import sys
...
try:
    ...
    print(f"room-doc replace offsets: FAIL — dependencies missing ({exc}).")
    sys.exit(1)
...
if FAILS:
    print("room-doc replace offsets: FAIL")
    for f in FAILS:
        print("  -", f)
    sys.exit(1)
print("room-doc replace offsets: ok")
