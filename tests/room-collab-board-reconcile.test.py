...
Run: python3 tests/room-collab-board-reconcile.test.py  (exit 0 pass / 1 fail)
"""
import asyncio
import sys
...
try:
    ...
    print(f"room-collab board reconcile: FAIL — dependencies missing ({exc}).")
    sys.exit(1)

from room_collab_board import BOARD_KIND, ELEMENTS_KEY  # noqa: E402

from room_collab_client import RoomDoc  # noqa: E402
from room_collab_protocol import DEFAULT_TEXT_NAME  # noqa: E402
...
if FAILS:
    print("room-collab board reconcile: FAIL")
    for f in FAILS:
        print("  -", f)
    sys.exit(1)
print("room-collab board reconcile: ok")
