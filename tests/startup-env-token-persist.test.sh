...
# Portable stat helpers (macOS stat -f syntax ≠ GNU stat -c syntax).
_perm() { python3 -c "import os,stat; print(oct(stat.S_IMODE(os.stat('$1').st_mode))[2:])"; }
_mtime() { python3 -c "import os; print(int(os.path.getmtime('$1')))"; }
