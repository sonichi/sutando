...
const BUILDER = fileURLToPath(
	new URL('../../../../../src/adapters/executor/claude-code/hooks/build-hook-settings.mjs', import.meta.url),
);
...
const ADVERSARIAL = [
	'/Users/john/ag2/sutando/src/adapters/executor/claude-code/hooks/obs-hook.sh',
