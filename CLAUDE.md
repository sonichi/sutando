...
**Windows task watcher:** Windows uses `src/task-dispatcher.ps1` because the CLI has no Monitor tool. See [details](docs/claude-md-moved-detail.md#windows-task-watcher).
