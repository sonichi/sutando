...
If you notice the stream watcher has stopped, re-arm it yourself via the `Monitor` tool as described above. See [`docs/task-watcher-hosting-modes.md`](docs/task-watcher-hosting-modes.md).
