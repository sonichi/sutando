...
// open_github_url — OPEN GitHub pages in the canonical repo (migrated from the
// discord-voice plugin, live-review batch item 4/6, Susan 2026-06-12: a generic
// browser tool belongs upstream). Pure URL resolution lives in ./github-url.ts.
