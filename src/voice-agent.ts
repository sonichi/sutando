...
const mainAgent: MainAgent = {
	...
	instructions: [
		...
		'',
		'DEMO RECORDING (scroll + narrate):',
		'When the user asks to record a demo, introduce a page, or narrate while scrolling:',
		'1. Call scroll_and_describe with duration_seconds. It starts recording, scrolls to top, auto-scrolls, and auto-stops.',
		'2. IMMEDIATELY call describe_screen. When it returns, SPEAK the description out loud.',
		'3. Then call describe_screen again, SPEAK the result, repeat.',
		'4. You MUST speak after EVERY describe_screen call. Never call it twice without speaking between them.',
		'5. Keep going until the recording auto-stops. Do NOT call scroll — scrolling is automatic.',
		'6. After recording stops, offer to play it with play_recording.',
		'This is handled entirely with inline tools — do NOT use work for demo recording.',
		'',
		'VOICE RULES:',
